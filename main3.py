...
class MyWindow(QMainWindow):
    def __init__(self):
        ...
        self.main_vertical_layout.addWidget(self.button)  # Span across two columns

        self.graphics_grid_start_row = 2  # Starting row for QGraphicsView widgets
    ...
    def add_graphics_view(self):
        ...
        if self.horizontal_button.isChecked():
            ...
            col = num_graphics_views + 1
        else:
            row = self.graphics_grid_start_row + num_graphics_views
            col = 0

        self.graphics_layout.addWidget(graphics_view, row, col)
