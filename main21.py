...
class MyWindow(QMainWindow):
    ...
    def setup_tab(self, tab, layout):
        ...
        button.clicked.connect(lambda: self.add_widget(tab, row_edit, col_edit, col_span_edit, row_span_edit))
    ...
    def add_widget(self, tab, row_edit, col_edit, col_span_edit, row_span_edit):
