...
class MyWindow(QMainWindow):
    ...
    def setup_tab(self, tab, layout, code_tab=False):
        ...
        button.clicked.connect(lambda: self.add_widget(tab, code_tab, row_edit, col_edit, col_span_edit, row_span_edit))
    ...
    def add_widget(self, tab, code_tab, row_edit, col_edit, col_span_edit, row_span_edit):
        ...
        if code_tab:
            ...
            self.add_plain_text_edit_to_layout(self.graphics_layout_2, row, col, rowspan, colspan)
        else:
